...
// onDoubleClick={SpeakOff}
  ...
  <textarea className="form-control" style={{backgroundColor:props.mode==='dark' ? '#3e3d83' : 'white', color:props.mode==='dark' ? 'white' : 'black'}} value={text} onChange={HandleOnChange} id="Box" rows="10"></textarea>
</div>
    <button  className="btn btn-primary mx-1 my-1" onClick={HandleUpperCaseClick} type="submit">Convert to UpperCase</button>
    <button className="btn btn-primary mx-1 my-1" onClick={HandleLowerCaseClick} type="submit">Convert to LowerCase</button>
    {/* <button className="btn btn-primary mx-1" onClick={RemoveUnwantedSpacesClick} type="submit">Remove Unwanted Spaces</button> */}
    <button className="btn btn-primary mx-1 my-1" onClick={Speak} type="submit">Speech</button>
    {/* <button className="btn btn-primary mx-1" onClick={SpeakOff} type="submit">SpeechOff</button> */}
    <button className="btn btn-primary mx-1 my-1" onClick={RemoveSpaces} type="submit">RemoveExtraSpaces</button>
    <button className="btn btn-primary mx-1 my-1" onClick={ClearText} type="submit">Clear</button>
    <button className="btn btn-primary mx-1 my-1" onClick={CopyText} type="submit">Copy</button>
    </div>
